...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post drawings_url, params: { drawing: { notes: @drawing.notes, title: @drawing.title } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { notes: @drawing.notes, title: @drawing.title } }
